...
- e.g. if $\pi$=0.10, when n=5, relative cost=0.61; when n=30, relative cost=0.99 -> pools of five better  
...
- Appropriate judgment-based measurement (e.g. visual size of the tree, bigger then older)
